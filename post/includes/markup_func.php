...
function do_html_chat($emb = false, $warn = true) {
	if (!isset($_SESSION['uid']) || empty($_SESSION['uid'])) { 
		...
		<p style="width: 960px; margin: 50px auto; text-align: center;" id="not_logged_in">
			To view the chat window on this page you have to be logged in, please click <a href="/post/login_form.php">here</a> to login.
		</p>
	<?php
		}
		return;
	...
	if ($emb === true) { ?>
		<div id="bar"><div id="toggle_chat" unselectable="on"><p><span>Click to Hide</span></p></div><a href="/post/logout.php" id="logout"><span>Logout</span></a></div>
	<?php
	}
	?>
		<div id="chat">
			...
			<?php 
			if ($emb === false) { ?>
				<div id="logout"><a href="/post/logout.php"><span>Logout</span></a></div>
				<div class="clear"></div>
			<?php
			}
			?>
		...
		<script type="text/javascript" src="/post/js/chat.js"></script>
<?php
}
